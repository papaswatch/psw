...
ALTER TABLE papas.product_liked ADD CONSTRAINT PK_PRODUCT_LIKED PRIMARY KEY (
                                                                           product_liked_id
    );

ALTER TABLE papas.product_qna_mapp ADD CONSTRAINT PK_PRODUCT_QNA_MAPP PRIMARY KEY (
                                                                                 product_qna_mapp_key
    );
...
ALTER TABLE papas.qna ADD CONSTRAINT PK_QNA PRIMARY KEY (
                                                       qna_id
    );

ALTER TABLE papas.product_discount ADD CONSTRAINT PK_PRODUCT_DISCOUNT PRIMARY KEY (
                                                                                 product_discount_id
    );

ALTER TABLE papas.delivery ADD CONSTRAINT PK_DELIVERY PRIMARY KEY (
                                                                 delivery_id
    );

ALTER TABLE papas.product_tag ADD CONSTRAINT PK_PRODUCT_TAG PRIMARY KEY (
                                                                       hashtag_key
    );

ALTER TABLE papas.product ADD CONSTRAINT PK_PRODUCT PRIMARY KEY (
                                                               product_id
    );
...
ALTER TABLE papas.comments ADD CONSTRAINT PK_COMMENTS PRIMARY KEY (
                                                                 comment_id
    );

ALTER TABLE papas.order ADD CONSTRAINT PK_ORDER PRIMARY KEY (
                                                           order_id
    );

ALTER TABLE papas.cart ADD CONSTRAINT PK_CART PRIMARY KEY (
                                                         card_id
    );

ALTER TABLE papas.product_image ADD CONSTRAINT PK_PRODUCT_IMAGE PRIMARY KEY (
                                                                           img_id
    );

ALTER TABLE papas.product_order_mapp ADD CONSTRAINT PK_PRODUCT_ORDER_MAPP PRIMARY KEY (
                                                                                     product_order_id
    );

ALTER TABLE papas.payment ADD CONSTRAINT PK_PAYMENT PRIMARY KEY (
                                                               payment_id
    );
...
ALTER TABLE papas.product_hashtag_mapp ADD CONSTRAINT PK_PRODUCT_HASHTAG_MAPP PRIMARY KEY (
                                                                                         product_hashtag_id
    );
