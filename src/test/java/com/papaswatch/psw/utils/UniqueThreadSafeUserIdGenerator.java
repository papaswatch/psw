...
public class UniqueThreadSafeUserIdGenerator {
...
//    private static final String[] delimiters = {"", "_", "-", ".", ""};
     ...
     */
    private static String generateRawUsername() {
...
//                for (int j = 0; j < 10; j++) {
//                    System.out.println(Thread.currentThread().getName() + ": " + generateUniqueUsername());
//                }
//            }));
//        }
//
...
//            }
//        });
//        int size = generatedIds.size();
//        System.out.println("generated id size = " + size);


        for (int i = 0; i < 100; i++) {
            String s = generateUniqueUsername();
            System.out.println(s);
        }
        System.out.println("generated id size = " + generatedIds.size());
